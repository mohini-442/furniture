        ...
        <>
            <div className='container mx-auto px-3 max-w-[1150px]'>
                <div onClick={() => setPosition({ ...position, position: { top: 0, left: 0 } })} className="fixed hidden bottom-[1%] right-[1%] z-30 translate-y-[0%] animate-bounce"
                    ref={scrollTop}
                ><div className=' cursor-pointer w-[50px] h-[50px] bg-[#283444] flex items-center justify-center rounded-[25%] scroll-smooth transform-[all] transform-[.3s] transform-[linear] shadow-[0px_0px_18px_#fff]'>
