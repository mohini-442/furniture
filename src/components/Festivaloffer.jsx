...
function Festivaloffer() {
    return (
        <div>
            <div className="max-w-[1320px] px-3 mx-auto pb-24 pt-12" data-aos="fade-up"
                    ...
                    <div className='md:w-1/2 w-full px-3'>
                        <div className=' bg-[url(./assets/images/sofa1.png)] bg-no-repeat bg-center bg-size  h-[362 px] w-full lg:w-[64 2px]  mx-auto '>
                            ...
                            <div className='lg:pl-24 pl-12 pb-16  '>
                                ...
                                <p className='text-[#4d4d4d] font-poppins text-lg font-normal max-w-[262px] pt-2'>Lorem ipsum dolor sit amet, consectetur adipiscing elit</p>
                                <button className='bg-[#BD7D41] p-[10px_16px_10px_16px] text-white font-poppins text-xl  text-center font-medium mt-10  hover:text-[#BD7D41] hover:bg-[#fff] hover:border-[2px] hover:border-[#BD7D41] border-[transparent] border-[2px] duration-[0.5s]'>ADD TO CART</button>
                            </div>
                        </div>
                    </div>
                    <div className='md:w-1/2 w-full px-3'>
